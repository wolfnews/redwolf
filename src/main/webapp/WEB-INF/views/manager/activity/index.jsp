...
<html lang="en">
	<head>
		...
		<script	src="<%=basePath%>static/console/manager/activity.js"></script>
	</head>
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
			<script type="text/javascript">
				...
				function jump2addActivity(){
					location.href=base+'manage/activity/add.html';
				}
			</script>
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="well well-sm">
									<button class="btn btn-sm btn-danger" onclick="jump2addActivity()"> 
										<i class="ace-icon fa fa-pencil-square-o bigger-125"></i>
										<b>添加活动</b>
									</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</div>
								<div>
									<table id="manage_activity_list"></table>
								</div>
								<div id="manage_activity_page"></div>
							</div>
						</div>
					</div>
				</div>
