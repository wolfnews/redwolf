...
<html lang="en">
	<head>
		...
		<script src="<%=basePath%>static/console/manager/login.js"></script>
	</head>
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="white" id="id-text2"><strong>牛股会管理系统</strong></span>
								</h1>
							</div>
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" id="manager_login_username" placeholder="请输入账号..." />
															<i class="ace-icon fa fa-user"></i>
														</span>
													</label>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" class="form-control" id="manager_login_password" placeholder="请输入登录密码..." />
