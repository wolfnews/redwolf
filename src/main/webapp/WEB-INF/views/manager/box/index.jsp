...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<%=basePath%>static/ace/assets/css/jquery.gritter.css" />
		...
		<script src="<%=basePath%>static/ace/assets/js/jquery.gritter.js"></script>
		...
		<script	src="<%=basePath%>static/console/manager/box.js"></script>
	</head>
	<body class="no-skin">
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								<div>
									<table id="manage_box_list"></table>
								</div>
								<div id="manage_box_page"></div>
							</div>
						</div>
					</div>
				</div>
