...
<html lang="en">
	<head>
		...
		<script src="<%=basePath%>static/console/manager/manager.js"></script>
	</head>
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
			<script type="text/javascript">
				...
				function jump2addManager(){
					location.href=base+'manage/manager/add.html';
				}
			</script>
			<jsp:include page="../nav.jsp">
				<jsp:param value="manage_power" name="page_index"/>
			</jsp:include>		
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="well well-sm">
									<button class="btn btn-sm btn-danger" onclick="jump2addManager()"> 
										<i class="ace-icon fa fa-pencil-square-o bigger-125"></i>
										<b>添加管理员</b>
									</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</div>
								<div>
									<table id="manage_manager_list"></table>
								</div>
								<div id="manage_manager_page"></div>
							</div>
						</div>
					</div>
				</div>
