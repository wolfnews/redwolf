jQuery(function($) {
	var grid_selector = "#professor_subscribe_list";
	var page_selector = "#professor_subscribe_page";
	...
	jQuery(grid_selector).jqGrid({
		url : base+'professor/subscribe/pagination',
		datatype : "json",
		height : '100%',
		autowidth: true,
		colNames : ['用户名称', '用户级别', '订阅时间','到期时间'],
		colModel : [ 
			{name : 'username',index : 'username',width : 30},
			{name : 'level',index : 'level',width : 20},
			{name : 'gmtCreate',index : 'gmtCreate',width : 20},
			{name : 'gmtModify',index : 'gmtModify',width : 20}
		],
		viewrecords : true,
		rowNum : 10,
