...
<html lang="en">
	<head>
		...
		<script	src="<%=basePath%>static/console/professor/subscribe.js"></script>
	</head>
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
			...
			<jsp:include page="../nav.jsp">
				<jsp:param value="professor_subscribe" name="page_index"/>
			</jsp:include>			
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								<div>
									<table id="professor_subscribe_list"></table>
									<div id="professor_subscribe_page"></div>
								</div>
							</div>
						</div>
					</div>
