var grid_selector = "#profile_record_list";
var page_selector = "#profile_record_page";
jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		url : base+'profile/sr/list',
		datatype : "json",
		height : '100%',
		autowidth: true,
		colNames : ['订阅讲师','订阅时长（天）', '订阅日期'],
		colModel : [ 
			{name : 'professor',index : 'professor',width : 4},
			{name : 'subscribeTime',index : 'subscribeTime',width : 3},
